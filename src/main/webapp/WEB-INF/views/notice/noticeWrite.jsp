		...
		<div class="container">
			...
			<div class="row">
				<form action="ninsert.do" method="post"
					...
					<br>
					<p style="color: #52575c; font-size: 35px; margin-top: 5%;" align="center"><b>공지사항 등록</b></p>
					<br>
							...
							<table
								...
								<tr>
									...
									<td class="td"><input class="form-control"
										id="disabledInput" type="text" name="notice_title" required></td>
								</tr>
								<tr>
									<th class="th">작 성 자</th>
									<td class="td"><input class="form-control"
										id="disabledInput" type="text" name="user_id" readonly
										value="${ sessionScope.loginMember.user_id }" required></td>
								</tr>
								<tr>
									<th class="th">내 용</th>
									<td class="td"><textarea class="form-control"
											id='summernote' name="notice_content" rows="20" cols="50"
