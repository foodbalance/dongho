	...
	<section class="page-section cta">
	    ...
	    <br>
	        <div style="  border-radius: 1rem; border: 1px solid #52575c; padding: 5px; margin: 5px;" class="row">
		        <form action="trainup.do" method="post" enctype="multipart/form-data">
...
<!-- =============================================================================== -->				
							<table style=" border-collapse: collapse; width: 100%;background: white; border-radius: 1rem; border: 1px solid; padding: 5px; margin: 5px;text-align: center;"align="center" cellspacing="0" cellpadding="15">
								<tr><th class="th">제     목</th><td class="td"><input class="form-control" id="disabledInput" type="text" name="train_title" value="${ train.train_title }" required></td></tr>
								...
								<tr><th class="th">URL</th><td class="td" align="left" ><input class="form-control" id="disabledInput" type="text" name="train_url" value="${ train.train_url }" required></td></tr>
								<tr><th class="th">운동법 소개</th><td class="td"><textarea class="form-control" name="train_content" rows="5" cols="50" required>${ train.train_content }</textarea></td></tr>
...
<!-- =============================================================================== -->
						...
						<div style=" padding: 5px; margin: 5px; margin-bottom: 3%" align="center">
							<input style="margin-bottom: 1%; " class="btn btn-outline-secondary" type="submit" value="수정하기"> &nbsp;
